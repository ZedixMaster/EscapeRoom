...
part_type_size(global.Particle1,.1,.15,0,0);                    //This is for the size
part_type_scale(global.Particle1,.5,.75);                       //This is for scaling
part_type_color1(global.Particle1,c_gray);                  //This sets its colour. There are three different codes for this
part_type_alpha2(global.Particle1,0.8, 0.0);                        //This is its alpha. There are three different codes for this
